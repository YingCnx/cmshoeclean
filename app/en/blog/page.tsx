...
export const metadata: Metadata = {
  title: "Shoe Care Articles | CM Shoe Clean Chiang Mai",
  description:
    "A collection of articles on shoe care, service pricing, and tips to prevent common shoe problems in Chiang Mai.",
  alternates: {
    canonical: "/en/blog",
  },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Blog",
            name: "Shoe Care Articles - CM Shoe Clean",
            description:
              "A collection of articles on shoe care and shoe cleaning services in Chiang Mai.",
            blogPost: posts.map((post) => ({
              "@type": "BlogPosting",
              headline: post.title,
              datePublished: post.date,
              url: `https://www.cmshoeclean.com/en/blog/${post.slug}`,
            })),
          }),
        }}
      />
      ...
      <div className="bg-white font-sans overflow-hidden">
        ...
        <section className="bg-white py-16 md:py-24 text-center relative">
          <div className="container mx-auto px-6 relative z-10">
            <span className="text-[#27D7D0] font-black tracking-[0.3em] md:tracking-[0.4em] uppercase text-[10px] mb-4 block">
              Knowledge Hub
            </span>
            <h1 className="text-5xl md:text-7xl font-black text-[#1e293b] mb-6 tracking-tighter uppercase">
              Our <span className="text-[#27D7D0]">Blog</span>
            </h1>
            <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg font-medium leading-relaxed">
              Shoe care tips, service pricing, and practical knowledge
              <br className="hidden md:block" />
              from our shoe cleaning and restoration experts.
            </p>
          </div>
