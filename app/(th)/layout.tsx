...
export const metadata: Metadata = {
  ...
  title: {
    default: "ซักเกิบ เชียงใหม่ | ซักรองเท้า สปารองเท้าพรีเมียม | ซักเกิบแอนด์สปา",
    template: "%s | ซักเกิบแอนด์สปา เชียงใหม่",
  },

  description:
    "ซักเกิบ เชียงใหม่ — ร้านซักรองเท้าและสปารองเท้าในเชียงใหม่ บริการทำความสะอาดรองเท้าทุกประเภท แก้ขอบเหลือง กำจัดเชื้อรา พร้อมบริการรับ-ส่งฟรีในตัวเมือง เปิดทุกวัน",

  openGraph: {
    title: "ซักเกิบ เชียงใหม่ | ซักเกิบแอนด์สปา บริการซักรองเท้าและสปารองเท้า",
